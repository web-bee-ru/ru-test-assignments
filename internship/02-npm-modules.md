...
Для локальной разработки можно использовать папку `02-npm-modules`. Для запуска дев сервера перейдите туда и напишите `npm run start`

### Тесты

В папке `02-npm-modules` импортируйте ваши модули в `client/main/App.tsx`, затем запустите 
```
npm run start
